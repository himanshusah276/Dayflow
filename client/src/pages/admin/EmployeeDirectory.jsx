  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Manage company employees, job titles, roles, compensation structures, and access terms
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex flex-1 flex-col sm:flex-row items-center gap-3 w-full">
            ...
            <select
              ...
              className="w-full sm:w-auto px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold text-slate-800 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500"
            >
              ...
              <div>
                <div className="flex items-start justify-between gap-3 mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-semibold text-emerald-700 mt-0.5">{emp.designation}</p>
                ...
                <div className="space-y-2 py-3 border-t border-slate-100 text-xs text-slate-600">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-slate-800 capitalize">{emp.role?.replace('_', ' ')}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-slate-400 font-medium">Monthly Gross</span>
                    <span className="font-bold text-emerald-700 font-mono">${emp.gross_salary?.toLocaleString() || '—'}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-slate-400 font-medium">Email</span>
                    <span className="truncate max-w-[150px] font-medium text-slate-700">{emp.email}</span>
                  </div>
                </div>
              </div>
              ...
              <tbody className="divide-y divide-slate-100">
                {employees.map((emp) => (
                  <tr key={emp.id} className="hover:bg-slate-50/60 transition-colors">
                    ...
                    <td className="px-6 py-4 font-bold text-slate-900 font-mono">${emp.gross_salary?.toLocaleString() || '—'}</td>
                    <td className="px-6 py-4 capitalize text-slate-600">{emp.role?.replace('_', ' ')}</td>
                    <td className="px-6 py-4">
      ...
      <Modal
        ...
        subtitle="Create an employee record, login credentials, and initial compensation structure"
      >
        {addError && (
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                placeholder="EMP-109"
                className="block w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500 uppercase"
                required
              />
            </div>
            <div>
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setAddFormData({ ...addFormData, basicSalary: e.target.value })}
                placeholder="6500"
                className="block w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500"
                required
              />
